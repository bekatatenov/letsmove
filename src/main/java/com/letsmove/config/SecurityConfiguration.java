...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                .hasAuthority("ADMIN")
                .antMatchers("/save_place", "/add_place")
                .hasAnyAuthority("MANAGER", "ADMIN")
                .antMatchers("/save_tour", "/add_tour")
                .hasAuthority("GUIDE")
                .antMatchers("/get_all_tour", "/book_tour", "/getTour", "/save_tour_comment", "/get_all_place","/look_place", "/change_rating", "/save_place_comment")
                .authenticated()
                .anyRequest()
                .authenticated()
                .and().csrf().disable()
